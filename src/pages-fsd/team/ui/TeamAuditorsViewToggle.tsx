...
export type TeamAuditorsViewMode = 'cards' | 'list'

export function TeamAuditorsViewToggle ({
  value,
  onChange,
}: {
  value: TeamAuditorsViewMode
  onChange: (value: TeamAuditorsViewMode) => void
}) {
  return (
    <div className={styles.root} role="group" aria-label="Вид отображения аудиторов">
      <button
        type="button"
